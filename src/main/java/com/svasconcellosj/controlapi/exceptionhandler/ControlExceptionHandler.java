...
public class ControlExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> ConverterNotFoundException(ConverterNotFoundException ex, WebRequest request) {
	...
	public ResponseEntity<Object> SQLSyntaxErrorException(SQLSyntaxErrorException ex, WebRequest request) {
	...
	public ResponseEntity<Object> SQLSyntaxErrorException(InvalidDataAccessResourceUsageException ex, WebRequest request) {
